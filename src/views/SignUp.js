                ...
                <div className="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div className="card" style={{borderRadius: 15}}>
                        ...
                        <form onSubmit={(event)=>{this.sendSignUpInfo(event)}}>
                            ...
                            <input type="text" id="form3Example1cg" name="username" className="form-control form-control-lg" />
                            ...
                            <div className="form-outline mb-4">
                            <input type="password" id="form3Example4cg" name='password' className="form-control form-control-lg" />
                            <label className="form-label" htmlFor="form3Example4cg">Password</label>
                            </div>
                            <div className="form-outline mb-4">
                            <input type="password" id="form3Example4cdg" name='confirmPassword' className="form-control form-control-lg" />
                            <label className="form-label" htmlFor="form3Example4cdg">Confirm password</label>
                            </div>
                            <div className="d-flex justify-content-center">
                            <button type="submit" className="btn btn-warning btn-block btn-lg gradient-custom-4 text-body">Register</button>
                            </div>
